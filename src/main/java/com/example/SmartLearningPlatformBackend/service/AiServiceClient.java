...
public class AiServiceClient {
    ...
    public AiCourseResponse processDocument(byte[] fileContent, String filename, FileType fileType) {
        try {
    ...
    public List<Map<String, Object>> generateQuizQuestions(String lessonContent, List<String> previousQuestions) {
        try {
